...
public class NotificationListener implements NotifyListener {
    ...
    NotificationListener(Testauto container){
    ...
    {
    	System.out.println("onPrivateUpdate "+str+" "+bytes.toString());
    	container.result(0);
    ...
    {
    	System.out.println("onPrivateChat room "+str1+" chat"+str2);
    	container.result(0);
    ...
    public void onChatReceived(ChatEvent event) {        
       ...
       container.result(0);
		//container.notify(getdata.event.getResult());
